            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
                        <div class="login-box">
                        <a href="#"  id="basic" class="selectpicker show-tick form-control sign-up" data-toggle="dropdown"><?php echo $user?></a>
                ...
                <div class="navbar-header">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                            <li class="nav-item active"><a class="nav-link" href="dashboard_admin.php?username=<?php echo $user?>">Home</a></li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p><a class="btn hvr-hover" href="product_admin.php?username=<?php echo $user?>">Shop Now</a></p>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            ...
                            <a class="btn hvr-hover" href="#">Cactus</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            <img class="img-fluid" src="images/cat3.jpg" alt="" />
                            <a class="btn hvr-hover" href="#">Succulent</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            <img class="img-fluid" src="images/cat2.jpg" alt="" />
                            <a class="btn hvr-hover" href="#">Sets</a>
                        </div>
                    </div>
                </div>
            </div>
