                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                            <li class="nav-item active"><a class="nav-link" href='dashboard_user.php?username=<?php echo $user?>'>Home </a></li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p><a class="btn hvr-hover" href="product_user.php?username=<?php echo $user?>">Shop Now</a></p>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            ...
                            <a class="btn hvr-hover" href="cactus_user.php?username=<?php echo $user?>">Cactus</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            <img class="img-fluid" src="images/cat3.jpg" alt="" />
                            <a class="btn hvr-hover" href="succulent_user.php?username=<?php echo $user?>">Succulent</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            <img class="img-fluid" src="images/cat2.jpg" alt="" />
                            <a class="btn hvr-hover" href="sets_user.php?username=<?php echo $user?>">Sets</a>
                        </div>
                    </div>
                </div>
            </div>
