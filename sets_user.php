            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2>SETS</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard_user?username=<?php echo $user?>.php">Home</a></li>
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-12 col-xs-12 shop-content-right">
                        <div class="right-product-box">
                            <div class="product-item-filter row">
                                ...
                                <?php
                                    $query = 'SELECT prodname, price, stocks, picture_location FROM products where prodtype="Sets"'; 
                                    $result = mysqli_query($conn,$query);
                                ?>
